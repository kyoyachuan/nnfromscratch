...
from .plot import plot_curve_by_exp_group
...
class ExperimentCfg:
    def __init__(self, cfg: dict, name: str = None, exp_value: str = None):
        ...
        Args:
            ...
            exp_value (str): experiment value
        """
...
class ExperimentGroup:
    ...
    def __generate(self) -> ExperimentCfg:
        ...
        for exp_param in self.exp_value:
            ...
            plot_curve_by_exp_group(fname=f'result/{self.name}.png', title=self.name, **self._exp_results)
            ...
            for experiment in self.experiments:
                if experiment['enable'] == True:
                    ...
                    for exp in self.experiment_group:
                        print(exp)
                        self.experiment_group.results = fn(exp)
        return wrapper
